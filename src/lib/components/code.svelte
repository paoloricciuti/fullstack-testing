<script lang="ts">
	...
	import { type BundledLanguage, type SpecialLanguage, type BundledTheme } from 'shiki';
...
<style lang="postcss">
	...
	pre :global(br + .shiki-magic-move-item::before),
	pre :global(.shiki-magic-move-item:first-child) {
